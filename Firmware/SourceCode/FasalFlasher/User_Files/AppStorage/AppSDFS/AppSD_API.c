 ...
 * @return eStorageFSStatus_t
 */
static eStorageFSStatus_t SDFs_ReadFileRaw(sSDFS_t* const pMe, eStorageFileNamesEnums_t fileEnum, char* const pOutReadBuf, uint32_t bytesToRead,
 ...
 * @return eStorageFSStatus_t
 */
__attribute__((unused)) static eStorageFSStatus_t SDFs_WriteFileRaw(sSDFS_t* const pMe, eStorageFileNamesEnums_t fileEnum, bool IsAppend,
                                                                    const char* const pInWriteBuf, size_t bufSize)
{
    assert(NULL != pMe);
    assert(fileEnum < eFS_MAX);
 ...
 * @return eStorageFSStatus_t
 */
static eStorageFSStatus_t SDFs_ComputeFileCRC(sSDFS_t* const pMe, eStorageFileNamesEnums_t fileEnum, uint8_t* const pInOutRamBuf, uint32_t RamBufSize,
