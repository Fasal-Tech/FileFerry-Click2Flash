...
{
    TriColorLed_API_Indicate(gcAppIndicationTable[gPrevState].ledState, gcAppIndicationTable[gPrevState].ledBlinkPeriod,
                             gcAppIndicationTable[gPrevState].IsBlinkNeeded);
}
